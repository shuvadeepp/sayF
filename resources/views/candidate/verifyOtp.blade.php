          ...
          <form method="post" id="reset-form" autocomplete="off">
            {{csrf_field()}}
              <div class="otp-container">
                <div class="otp-box">
                  <input type="text" maxlength="4" class="otp-input-field" maxlength="32" name="otpcandiate" id="otpcandiate" placeholder="">
                   <span class="errMsg_otpcandiate errDiv"></span>
                </div>
              </div>
...
>
  ...
  function validator()
  {
      ...
      $('.error-input').removeClass('error-input');
       if (!blankCheck('otpcandiate', 'OTP can not be left blank'))
          return false;
      $('#reset-form').submit();  
