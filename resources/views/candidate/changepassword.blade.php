          ...
          <div class="col-12 col-md-6">
            <div class=" dashboard-box p-4">
               <div class="utf-input-with-icon show-password">
                <input type="password" class="utf-with-border" maxlength="32" name="oldpassword" id="oldpassword"
              ...
              <div class="utf-input-with-icon show-password">
                <input type="password" class="utf-with-border" maxlength="32" name="newpassword" id="newpassword"
              ...
              <div class="utf-input-with-icon show-password">
                <input type="password" class="utf-with-border" maxlength="32" name="conpassword" id="conpassword"
              ...
              <button class="button full-width utf-button-sliding-icon ripple-effect margin-top-10" type="submit"
                onclick="return validator();">Change password<i class="icon-feather-chevrons-right"></i></button>
            </div>
          </div>
        </div>
      </div>
