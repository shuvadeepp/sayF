...
@endsection
  <div class="utf-dashboard-content-container-aera" data-simplebar>
    ...
    <div class="utf-dashboard-content-inner-aera"> 
      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="utf-intro-banner-search-form-block mb-18"> 
          
           <div class="utf-input-with-icon">
              <input id="import_job" name="import_job" class="import_job" type="file" style="height: 68px;
    line-height: 38px;">
            ...
            <div class="utf-intro-search-button">
              <button name="importjob" class="button ripple-effect"> Import</button>
            </div>
