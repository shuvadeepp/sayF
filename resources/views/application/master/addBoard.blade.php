...
@section('page-content')
  ...
  <div class="utf-dashboard-content-container-aera" data-simplebar>
    ...
    <div class="utf-dashboard-content-inner-aera"> 
      ...
      <div class="col-xl-12">
        <div class="mb-2">
          <a href="<?php echo ROOT_URL.'/application/master/board'?>" class="button utf-ripple-effect-dark">View Board</a>      
        </div>
      </div>
                ...
                <div class="row">
                  <div class="col-xl-6 col-md-6 col-sm-6">
                    <div class="utf-submit-field">
                      <h5>Board Name *</h5>
                      <input type="text" class="utf-with-border" placeholder="Board Name" name="txtBoard" id="txtBoard" value="{{!empty($editCatDetail['boardName'])?(!empty(old('txtBoard')))?old('txtBoard'):$editCatDetail['boardName']:old('txtBoard')}}">
                      <span class="errMsg_txtBoard errDiv"></span>
                    </div>
                  </div>
...
>
  ...
  {
      $('.errDiv').hide();
      if (!blankCheck('txtBoard', 'Board can not be left blank'))
          return false;
