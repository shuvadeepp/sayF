...
@section('page-content')
  ...
  <div class="utf-dashboard-content-container-aera" data-simplebar>
    <div id="dashboard-titlebar" class="utf-dashboard-headline-item">
      <div class="row">
        <div class="col-xl-12"> 
          <h3>View Did you know</h3>
          <nav id="breadcrumbs">
            <ul>
              <li><a href="javascript:void(0);">Home</a></li>
              <li>Manage Master</li>
              <li>view Did you know</li>
            </ul>
          </nav>
        </div>
      </div>    
    ...
    <div class="utf-dashboard-content-inner-aera"> 
      <div class="row"> 
        <div class="col-xl-12">
          <div class="mb-2">
            <a href="<?php echo ROOT_URL.'/application/master/Douknow/add/'?>" class="button utf-ripple-effect-dark">Add  Did you know</a>      
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-12">
        ...
        <div class="dashboard-list-box table-responsive invoices with-icons">
          ...
          <thead>
            <tr>
            <th class="width-50"><input type="checkbox" name="" id="chkAll" value="" class="mb-0 chkAll"></th>
          ...
          <tbody>
           ...
           <tr <?php if($row->publishStatus==1){ ?>class="unpublish" <?php }else {?>class="publish"<?php } ?>>
              <td><input type="checkbox" name="chkItem[]" class="mb-0 chkItem" value="{{$row->douknowId}}"></td>
              <td>{{$ctr}}</td>
              <td>{{$row->Description}}</td>
              <td><a href="<?php echo ROOT_URL.'/application/master/Douknow/add/'.encrypt($row->douknowId)?>" class="btn btn-primary btn-xs" style="position: relative;top: 4px;">Edit</a></td>
            </tr>
          <?php $ctr++ ;} ?>
          </tbody>
          </table>
