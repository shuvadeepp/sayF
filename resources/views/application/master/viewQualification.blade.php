...
@section('page-content')
  ...
  <div class="utf-dashboard-content-container-aera" data-simplebar>
    <div id="dashboard-titlebar" class="utf-dashboard-headline-item">
      <div class="row">
        <div class="col-xl-12"> 
          <h3>View Job Qualification</h3>
          <nav id="breadcrumbs">
            <ul>
              <li><a href="javascript:void(0);">Home</a></li>
              <li>Manage Master</li>
              <li>View Job Qualification</li>
            </ul>
          </nav>
        </div>
      </div>    
    ...
    <div class="utf-dashboard-content-inner-aera"> 
      <div class="row"> 
        <div class="col-xl-12">
          <div class="mb-2">
            <a href="<?php echo ROOT_URL.'/application/master/qualification/add/'?>" class="button utf-ripple-effect-dark">Add Job Qualification</a>      
          </div>
        </div>
      </div>
            ...
            <tbody>
              ...
              if($arrAllRecords->isNotEmpty()){
                foreach ($arrAllRecords as $row){ ?>
                  ...
                  <td><input type="checkbox" name="chkItem[]" class="mb-0 chkItem" value="{{$row->qualificationId}}"></td>
                    <td>{{$ctr}}</td>
                    <td>{{$row->qualification}}</td>
                    <td class="text-center"><a href="<?php echo ROOT_URL.'/application/master/qualification/add/'.encrypt($row->qualificationId)?>" class="btn btn-primary btn-xs" style="position: relative;top: 4px;">Edit</a></td>
                  </tr>
