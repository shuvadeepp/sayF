...
@section('page-content')
  ...
  <!-- View Banner -->
  <?php $pageArrr = array('0'=>'','1'=>'Home','2'=>'About us','3'=>'Employers','4'=>'NGO-and-communities','5'=>'Persons with Disabilitie','6'=>'Policy advocacy','8'=>'Donate','9'=>'Volunteer','10'=>'Resource','11'=>'Connect','12'=>'Explore job','13'=>'Gallery', '14'=>'LetsSay-OurBlogs','15'=>'Press Release','16'=>'Job Details','17'=>'Blog Details','18'=>'User Login','19'=>'Register','20'=>'Forget Password','21'=>'Linkedin Feeds'); ?>
  ...
  <div class="utf-dashboard-content-container-aera" data-simplebar>
    ...
    <div class="utf-dashboard-content-inner-aera"> 
      <div class="row"> 
        <div class="col-xl-12">
          <div class="mb-2">
            <a href="<?php echo ROOT_URL.'/application/master/banner/add/'?>" class="button utf-ripple-effect-dark">Add Banner</a>      
          </div>
        </div>
      </div>
...
Sl No.</th>
          ...
          <tbody>
            ...
            <tr <?php if($row->publishStatus==1){ ?>class="unpublish" <?php }else {?>class="publish"<?php } ?>>
              <td><input type="checkbox" name="chkItem[]" class="mb-0 chkItem" value="{{$row->bannerId}}"></td>
              <td>{{$ctr}}</td>
              <td>{{$row->bannerTitle}}</td>
              <td>{{$row->bannerText}}</td>
              <td>{{$pageArrr[$row->pageType]}}</td>
              <td class="text-center"><a href="<?php echo ROOT_URL.'/application/master/banner/add/'.encrypt($row->bannerId)?>" class="btn btn-primary btn-xs" style="position: relative;top: 4px;">Edit</a></td>
