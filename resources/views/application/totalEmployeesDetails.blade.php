      ...
      <div class="col-xl-12">
        ...
        <div class="dashboard-list-box table-responsive invoices with-icons">
          ...
          <thead>
            ...
            <th> DOB </th>
            <th> Company Name </th>     
            <th class="text-center width-100" colspan="2">Action</th>
            </tr>
          </thead>
          <tbody>
            <?php
            ...
            <tr>         
            <?php 
              // echo'<pre>';print_r($row->userId);exit;
            ...
            ?>
              ...
              <td class="text-center">
                <a href="<?php echo ROOT_URL.'/application/Dashboard/listEmployeesDetails/'. encrypt($row->userId)?>" class="btn btn-primary btn-xs" style="position: relative;top: 4px;">View</a>
              </td>  
              <td class="text-center">
                <?php
                $statusCssClass="btn-danger";
                $statusLable="Make It Inactive";
                  if($row->publishStatus==0)
                  {
                    $statusLable="Make It Active";
                    $statusCssClass="btn-success";
                  } 
                ?>
                <a href="<?php echo ROOT_URL.'/application/Dashboard/publishEmployee/'. encrypt(json_encode(['user_id'=>$row->userId,'publishStatus'=>$row->publishStatus])) ?>" class="btn {{ $statusCssClass }} btn-xs" style="position: relative;top: 4px;">{{ $statusLable }}</a>
              </td>  
